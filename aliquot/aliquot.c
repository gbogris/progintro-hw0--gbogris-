...

{
	...
	if (scanf("%lf", &n) != 1 || n != (int)n || n >= 1e15) /* if n is not an integer, n surpasses the number 1e15 or the scanf is not getting the approriate number then there will be an error */
